package com.memoire.kital.raph.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("classe1");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("classe1");
        ...
        config.getMapConfigs().put("com.memoire.kital.raph.domain.*", initializeDomainMapConfig(jHipsterProperties));
